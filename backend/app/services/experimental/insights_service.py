...
⚠️ EXPERIMENTAL: Deep Focus (Flow Index, Deep Work) temporarily disabled in production.
This logic may be re-enabled in future versions with improved accuracy.
See summary_endpoint.py for production insights calculation (only Anomalies & Wellness active).
